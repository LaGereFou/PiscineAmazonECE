    ...
    <section class="section-title">
        <div class="container text-center">
            ...
            <span class="bordered-icon"><i class="fa fa-circle-thin"></i></span>
                ...
                <form method="post" action="firstacheteur1.php">
					<label for="statut1">Êtes-vous déjà incrit? </label><select type="form-control" name="statut1"/>
                    <option name="connecter">Oui, me connecter</option> 
                    <option name="inscrire">Non, m'inscrire</option>
                    </select>
