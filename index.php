        ...
        <div class="container text-center">
            ...
            <span class="bordered-icon"><i class="fa fa-circle-thin"></i></span>
                ...
                <form method="post" action="authentification.php">
					<label for="statut">Quel est votre statut:</label><select type="form-control" name="statut"/>
                    <option name="admin">Administrateur</option> 
                    <option name="vendeur">Vendeur</option>
                    <option name="acheteur">Acheteur</option>
                    </select>
                <input type="submit" name= "buttonstatut" value="Confirmer"/>
                </form>
    </section>
